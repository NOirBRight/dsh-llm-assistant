window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const ASSISTANT_SEND_ENDPOINT = "assistant/send";
		...
		var AssistantController = class {
			...
			isPolling = () => this.#pollTimer !== void 0;
			subscribe = (listener) => {
			...
			async send(text, images, currentTask) {
				...
				try {
					...
					if (result.value.sent !== true) return false;
					this.#syncPoll();
					await this.#fetch();
					return true;
				} catch {
			...
			async newConversation() {
				let result;
				try {
					result = await this.#rpc.call(ASSISTANT_RPC_CHANNEL, ASSISTANT_ROLLOVER_ENDPOINT, {});
				} catch (error) {
			...
			#syncPoll() {
				if (!(this.#panelOpen && this.#watching && !this.#streamOpen && this.#snapshot?.status === "running")) {
					this.#stopPolling();
					return;
				}
		...
		*/
		...
		function StandardActivityIndicator({ startTime, locale = "zh" }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				role: "status",
				"aria-live": "polite",
				children: [locale.toLocaleLowerCase().startsWith("zh") ? "正在深入思考…" : "Deep diving...", elapsedMs >= 15e3 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		function AssistantContextMeter({ context, usedLabel = "of context used" }) {
		...
		//#endregion
		//#region src/unread.ts
		/** Unread baseline for the seat whale (AC-BUBBLE-1/3). */
		function nextUnreadBaseline(stored, currentSeq) {
			return stored === null ? currentSeq : stored;
		}
		function shouldShowUnread(open, lastSeenSeq, currentSeq) {
		...
		function AssistantSeat({ controller, locale, useSessions }) {
			...
			const copy = (key) => localeText(localeSnapshot.active, key);
			const currentTaskRef = (0, react.useRef)(void 0);
			useSessions((state) => {
				const entry = state.current === void 0 ? void 0 : state.byId[state.current];
				currentTaskRef.current = entry === void 0 || entry.origin === "subagent" || entry.blank ? void 0 : {
					sessionId: entry.id,
					...entry.displayTitle === void 0 ? {} : { label: entry.displayTitle }
				};
				return true;
			});
			(0, react.useEffect)(() => {
			...
			const send = () => {
				...
				setSendError(null);
				controller.send(text.length === 0 && payload.length > 0 ? " " : text, payload, currentTaskRef.current).then((ok) => {
					if (!ok) {
				...
				children: [
					open && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										children: rolloverBusy ? copy("switching") : copy("newConversation")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: empty ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									busy && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StandardActivityIndicator, {
										...snapshot?.turnStartTime === void 0 ? {} : { startTime: snapshot.turnStartTime },
										locale: localeSnapshot.active
									})
								] })
							}),
							...
							snapshot?.notice !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: cls.empty,
								style: {
									padding: "4px 12px 0",
									margin: 0
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantContextMeter, {
														context,
														usedLabel: copy("contextUsed")
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														type: "submit",
														className: cls.send,
		...
		function TimelineRow({ item, controller, locale, lastAssistantSeq, busy, feedback, onFeedback, onBranch, onOpenImage }) {
			...
			if (item.kind === "plugin") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: cls.taskMarker,
				"data-plugin": item.plugin,
				children: [
					pluginMarkerLabel(item.plugin, locale),
					" · ",
					item.text
				]
			});
			if (item.kind === "task-reference") {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: cls.taskMarker,
					children: [
						localeText(locale, "referenced"),
						" · ",
						item.receipt.label,
						" · ",
						String(item.receipt.sourceSessionIds.length),
						" ",
						localeText(locale, "sources"),
						omitted
					]
				});
			}
			...
			if (item.kind === "tool") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StandardToolRow, {
				...
				status: item.status,
				...item.input === void 0 ? {} : { input: item.input },
		...
		function pluginMarkerLabel(plugin, locale) {
