...
`;
		...
		*/
		...
		function StandardAssistantMessage({ text, streaming = false }) {
		...
		function StandardUserMessage({ text, images }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [images, text !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		function TimelineRow({ item, controller, locale, onOpenImage }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StandardFlowBody, { children: blocks.map((block, index) => block.kind === "reasoning" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StandardReasoningRow, {
				text: block.text,
				running: false
			}, index) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(StandardAssistantMessage, { text: block.text }, index)) });
		}
