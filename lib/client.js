	...
	factory: (require) => {
		...
		*/
		...
		const cls = {
			...
			"taskChip": "dsh-assistant-task-chip",
			"taskChipButton": "dsh-assistant-task-chip-button",
			"taskPicker": "dsh-assistant-task-picker",
			"taskSearch": "dsh-assistant-task-search",
			"taskList": "dsh-assistant-task-list",
			"taskOption": "dsh-assistant-task-option",
			"taskMeta": "dsh-assistant-task-meta",
			"taskAction": "dsh-assistant-task-action",
...
.dsh-assistant-task-chip { display:flex; align-items:center; gap:4px; margin:8px 10px 0; padding:5px 8px; border:1px solid var(--dsw-alias-border-l2); border-radius:8px; background:var(--dsw-alias-bg-layer-2); color:var(--dsw-alias-label-secondary); font-size:12px; min-width:0; }
.dsh-assistant-task-chip > span { min-width:0; flex:1; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
.dsh-assistant-task-chip-button { flex:none; border:0; padding:1px 4px; border-radius:5px; background:transparent; color:var(--dsw-alias-label-tertiary); cursor:pointer; }
.dsh-assistant-task-chip-button:hover { background:var(--dsw-alias-interactive-bg-hover); color:var(--dsw-alias-label-primary); }
.dsh-assistant-task-picker { position:absolute; left:8px; right:8px; bottom:42px; z-index:120; padding:8px; border:1px solid var(--dsw-alias-border-inverted); border-radius:10px; background:var(--dsw-specific-menu); box-shadow:var(--dsw-shadow-lv3); }
.dsh-assistant-task-search { box-sizing:border-box; width:100%; margin-bottom:6px; padding:6px 8px; border:1px solid var(--dsw-alias-border-l2); border-radius:7px; outline:none; background:transparent; color:var(--dsw-alias-label-primary); font:inherit; }
.dsh-assistant-task-list { max-height:180px; overflow:auto; }
.dsh-assistant-task-option { display:block; width:100%; padding:7px 8px; border:0; border-radius:7px; background:transparent; color:var(--dsw-alias-label-primary); text-align:left; cursor:pointer; }
.dsh-assistant-task-option:hover { background:var(--dsw-alias-interactive-bg-hover); }
.dsh-assistant-task-meta { display:block; margin-top:1px; overflow:hidden; color:var(--dsw-alias-label-tertiary); font-size:11px; text-overflow:ellipsis; white-space:nowrap; }
.dsh-assistant-task-action { height:28px; padding:0 7px; border:0; border-radius:7px; background:transparent; color:var(--dsw-alias-label-secondary); font-size:12px; cursor:pointer; }
.dsh-assistant-task-action:hover { background:var(--dsw-alias-interactive-bg-hover); color:var(--dsw-alias-label-primary); }
.dsh-assistant-task-action:disabled { opacity:.45; cursor:default; }
...
`;
		...
		function AssistantSeat({ controller, useSessions }) {
			const [open, setOpen] = (0, react.useState)(false);
			const [lastSeenSeq, setLastSeenSeq] = (0, react.useState)(null);
			const [draft, setDraft] = (0, react.useState)("");
			const [images, setImages] = (0, react.useState)([]);
			const [task, setTask] = (0, react.useState)(() => readTaskBinding());
			const [taskPickerOpen, setTaskPickerOpen] = (0, react.useState)(false);
			const [taskSearch, setTaskSearch] = (0, react.useState)("");
			...
			const taskCandidates = sessionList.ids.map((id) => sessionList.byId[id]).filter((entry) => entry !== void 0 && entry.origin !== "subagent" && !entry.blank).filter((entry) => taskSearch.trim() === "" || (entry.displayTitle + " " + (entry.cwd ?? "")).toLocaleLowerCase().includes(taskSearch.trim().toLocaleLowerCase())).sort((left, right) => left.id === sessionList.current ? -1 : right.id === sessionList.current ? 1 : right.updatedAt - left.updatedAt);
			(0, react.useEffect)(() => {
				let cardObserver;
				let phaseObserver;
				let observedCard;
			...
			(0, react.useEffect)(() => {
				...
				if (assistantSessionId === void 0) return;
				setTask((current) => current === void 0 || current.assistantSessionId === assistantSessionId ? current : {
					...current,
					refresh: true
				});
			}, [snapshot?.sessionId]);
			...
			const send = () => {
				...
				setSendError(null);
				controller.send(text.length === 0 && payload.length > 0 ? " " : text, payload, task === void 0 ? void 0 : {
					anchor: {
					...
					setDraft("");
					if (task !== void 0) setTask({
						...task,
						refresh: false,
						...snapshot?.sessionId === void 0 ? {} : { assistantSessionId: snapshot.sessionId }
					});
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									busy && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: snapshot?.currentTool !== void 0 ? `调用 ${snapshot.currentTool}…` : "思考中…"
									}),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: empty ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: [
										items.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TimelineRow, {
											item,
											controller,
											onOpenImage: (url, alt) => {
												setPreview({
										...
										thinking !== void 0 && thinking.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: cls.thinking,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: cls.thinkingLabel,
												children: "思考"
											}), thinking]
										}),
										pending !== void 0 && pending.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: cls.assistant,
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MiniMarkdown, {
												text: pending,
												streaming: true
											})
										})
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("form", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: cls.card,
									children: [
										task !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: cls.taskChip,
											children: [
										...
										taskPickerOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: cls.taskPicker,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
												...
												children: [taskCandidates.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													type: "button",
													className: cls.taskOption,
													onClick: () => {
														setTask({
															sessionId: entry.id,
													...
													children: [
														entry.displayTitle,
														entry.id === sessionList.current ? " · 当前" : "",
														entry.cwd !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															className: cls.taskMeta,
															children: entry.cwd
														})
													]
												}, entry.id)), taskCandidates.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
													className: cls.taskMeta,
													children: "没有可引用的任务"
												})]
											})]
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														type: "button",
														className: cls.taskAction,
														disabled: snapshot?.taskReferenceAvailable === false,
														onClick: () => {
															setTaskPickerOpen((value) => !value);
														},
														children: "引用任务"
													})
												]
		...
		function TimelineRow({ item, controller, onOpenImage }) {
			if (item.kind === "user") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: cls.userRow,
				children: [item.images !== void 0 && item.images.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}), item.text !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: cls.userBubble,
					children: item.text
				})]
			});
			...
			if (item.kind === "error") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: cls.error,
				children: item.text
			});
			if (item.kind === "tool") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: cls.tool,
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: cls.toolTitle,
							children: item.name
						}),
						item.summary !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: cls.toolSep }),
						item.summary !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: cls.toolSummary,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: cls.assistant,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MiniMarkdown, { text: item.text })
			});
		}
		...
		*  centers the card mid-column; following that bottom would lift the whale. */
		...
		function readTaskBinding() {
			try {
				const raw = window.localStorage.getItem(TASK_BINDING_KEY);
				if (raw === null) return void 0;
				const value = JSON.parse(raw);
				if (typeof value.sessionId !== "string" || typeof value.label !== "string") return void 0;
				return {
		...
		function writeTaskBinding(task) {
			try {
				if (task === void 0) window.localStorage.removeItem(TASK_BINDING_KEY);
